...
| stop_loss_pct | 止损百分比 | 0.8% |
| max_hold_seconds | 最大持仓时间 | 28800秒 |
| cooldown_seconds | 交易冷却时间 | 600秒 |
| max_daily_trades | 日最大交易次数 | 15次 |
| rsi_oversold | RSI超卖线 | 30.0 |
| rsi_overbought | RSI超买线 | 100.0 |
